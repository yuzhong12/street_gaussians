...
print("outside PID", os.getpid(), "CUDA_VISIBLE_DEVICES", os.environ.get("CUDA_VISIBLE_DEVICES"))
print("torch sees", torch.cuda.device_count(), "devices")
...
def get_free_gpu():
    ...
    for i in range(device_count):
        ...
        free_memory.append((i, memory_info.free))
...
def training():
    ...
    # print(f"Using GPU with the most available memory: physical GPU-{gpu_id}")
